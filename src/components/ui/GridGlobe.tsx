...
export const GridGlobe2 = () => {
  const globeConfig = {
    ...
    rings: 1,
    maxRings: 6,
    initialPosition: { lat: 1.3193, lng: 114.1694 },
    autoRotate: true,
    autoRotateSpeed: 1,
  };
  ...
  return (
    // remove dark:bg-black bg-white h-screen md:h-auto  w-full flex-row py-20
    // change absolute -left-5 top-36, add w-full h-full md:top-40
    <div className="flex items-center justify-center absolut -left-5 top-36 md:top-40 w-full h-full">
      {/* remove h-full md:h-[40rem] */}
      <div className="max-w-7xl mx-auto w-full relative overflow-hidden h-96 px-4">
        {/* remove these text divs */}
        {/* <motion.div
